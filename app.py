...
def calendar_view():
    ...
    # events = [current_date.day,current_date.month,current_date.year,period_length]
    events = str(current_date)
    # print(events)
    return render_template('calender1.html', events=events,period_length = period_length)
